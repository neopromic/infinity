...
export const Features = () => {
  return (
    <section className="bg-linear-to-b from-muted to-background py-12 w-full min-h-[calc(100vh-3rem)]">
      <div className="items-start gap-6 lg:gap-12 grid lg:grid-cols-2 px-4 md:px-6 container">
        <div className="space-y-2">
          <h2 className="font-bold text-3xl text-center sm:text-4xl md:text-5xl lg:text-left tracking-tighter">
            Exercícios recomendados
          </h2>
          <p className="max-w-[600px] text-center text-muted-foreground md:text-xl/relaxed lg:text-left lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
          ...
          <Card>
            ...
            <CardContent className="space-y-2 p-4">
              ...
              <p className="text-muted-foreground">
                Uma rotina abrangente que encobre todos os principais grupos
                musculares.
              </p>
            </CardContent>
          </Card>
